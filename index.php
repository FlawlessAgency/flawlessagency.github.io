...
<body>
		...
		<section class="box-planos">
			<div class="center">
				<div class="box-planos-single">
					...
					<div class="pontos-plano">
						<p><i class="fa fa-check-square"></i> Artes da sua escolha</p>
						<p><i class="fa fa-check-square"></i> Renders 3D profissionais</p>
						<p><i class="fa fa-check-square"></i> Os melhores designers do mercado</p>
						<p><i class="fa fa-check-square"></i> 20 artes por um preco muito bom</p>
					</div><!--pontos-plano-->
					<div class="preco">
						<h2>R$40,00</h2>
					</div><!--preco-->
			...
			<div class="box-planos-wraper">
					...
					<div class="pontos-plano">
						...
						<p><i class="fa fa-check-square"></i> Renders 3D profissionais</p>
						<p><i class="fa fa-check-square"></i> Os melhores designers do mercado</p>
						<p><i class="fa fa-check-square"></i> 50 artes pelo melhor preco</p>
					</div><!--pontos-plano-->
					<div class="preco">
						<h2>R$90,00</h2>
					</div><!--preco-->
			...
			<div class="box-planos-wraper">
					...
					<div class="pontos-plano">
						...
						<p><i class="fa fa-check-square"></i> Renders 3D profissionais</p>
						<p><i class="fa fa-check-square"></i> Os melhores designers do mercado</p>
						<p><i class="fa fa-check-square"></i> 100 artes pelo melhor preco</p>
					</div><!--pontos-plano-->
					<div class="preco">
						<h2>R$160,00</h2>
					</div><!--preco-->
	...
	<section class="parallax">
		...
		<div class="center">
			<h2>Sobre nossa <span style="color: #2692FF;">agencia</span></h2>
		...
		<div class="center">
			...
			<div class="w50 time">
				...
				<div class="w50 equipe-single">
					<div class="topo-box-usuario">
						<div class="box-avatar"></div><div class="info-usuario">
							<p style="font-weight: bold;">Crow Designer</p>
							<p style="font-weight: italic;">CEO / Designer</p>
						</div>
				...
				<div class="w50 equipe-single">
					<div class="topo-box-usuario">
						<div class="box-avatar"></div><div class="info-usuario">
							<p style="font-weight: bold;">Matheus Designer</p>
							<p style="font-weight: italic;">CEO / Designer</p>
						</div>
					</div><!--topo-box-usuario-->
					<div class="descricao-usuario-box">
				...
				<div class="w50 equipe-single">
					<div class="topo-box-usuario">
						<div class="box-avatar"></div><div class="info-usuario">
							...
							<p style="font-weight: italic;">Designer</p>
						</div>
					</div><!--topo-box-usuario-->
					<div class="descricao-usuario-box">
						<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit</p>
	...
	<footer>
		<p>Todos os direitos reservados a Flawless Agency</p>
	</footer>
